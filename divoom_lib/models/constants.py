...
TEMPRETURE_CHANNEL = 0x01   # APK canonical alias (TEMPRETURE display mode)
...
# Scheduling/SPP/display/table constants live in a sibling module
# (split for the 500-LOC rule); re-exported here so `from .constants import *`
# still yields every name.
from .constants_scheduling import *  # noqa: E402,F401,F403
