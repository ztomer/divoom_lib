...
class Music:
    ...
    async def get_sd_play_name(self):
        ...
        response = await self.communicator.send_command_and_wait_for_response("get sd play name")
    ...
    async def get_sd_music_list(self, start_id: int, end_id: int):
        ...
        response = await self.communicator.send_command_and_wait_for_response("get sd music list", args)
    ...
    async def get_volume(self):
        ...
        response = await self.communicator.send_command_and_wait_for_response("get volume")
    ...
    async def get_play_status(self):
        ...
        response = await self.communicator.send_command_and_wait_for_response("get play status")
        if response and len(response) >= 1:
    ...
    async def set_sd_play_music_id(self, music_id: int):
        ...
        return await self.communicator.send_command("set sd play music id", list(args))
    ...
    async def set_sd_last_next(self, action: int):
        ...
        args = [action]
        return await self.communicator.send_command("set sd last next", args)
    ...
    async def send_sd_list_over(self):
        ...
        return await self.communicator.send_command("send sd list over")
    ...
    async def get_sd_music_list_total_num(self):
        ...
        response = await self.communicator.send_command_and_wait_for_response("get sd music list total num")
        if response and len(response) >= 2:
    ...
    async def get_sd_music_info(self):
        ...
        response = await self.communicator.send_command_and_wait_for_response("get sd music info")
    ...
    async def set_sd_music_info(self, current_time: int, music_id: int, volume: int, status: int, play_mode: int):
        ...
        return await self.communicator.send_command("set sd music info", args)
    ...
    async def set_sd_music_position(self, position: int):
        ...
        return await self.communicator.send_command("set sd music position", list(args))
    ...
    async def set_sd_music_play_mode(self, play_mode: int):
        ...
        args = [play_mode]
        return await self.communicator.send_command("set sd music play mode", args)
    ...
    async def app_need_get_music_list(self):
        ...
        return await self.communicator.send_command("app need get music list")
